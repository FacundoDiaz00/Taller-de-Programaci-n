 ...
 * 
 */
@WebServiceClient(name = "WebServiceActividadesService", targetNamespace = "http://actividadesTuristicasService.publicar/", wsdlLocation = "http://localhost:5055/webservicesActividades/actividades?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:5055/webservicesActividades/actividades?wsdl");

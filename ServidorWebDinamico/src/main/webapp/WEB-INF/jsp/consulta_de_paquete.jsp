			                ...
			                <div class="row g-0">
			                    <form id="form-comprar" action="CompraPaquete" method="post">
			                        <div class="contenedorinput mb-3">
			                            ...
			                            <input name="cant_turistas" type="number" min="1" required class="form-control" placeholder="Ingrese la cantidad de turistas para la compra" aria-label="" aria-describedby="basic-addon1">
			                        </div>

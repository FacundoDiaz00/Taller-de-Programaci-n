...
public interface IControladorActividadTuristica {
	...
	void altaActividadTuristica(String nombreProveedor, String departamento, String nombreActividad, String descripcion,
			...
			String urlVideo) throws ActividadTuristicaYaRegistradaException, ObjetoNoExisteEnTurismoUy;
	...
	/**
	 * Crea la inscrpicon de un turistia a una salida turistica Notar que en la
	 * estacion de trabajo este ultimo parametro siempre tiene que ir en null
	 *
	 * @param nomSalTurim
	 * @param nicknameTuris
	 * @param canTuris
	...
	// Esto sumariza los casos de uso aceptar/rechazar y finalizar actividad
	// turística
	void cambiarEstadoDeActividadTuristica(String idActividad, EstadoActividadTuristica nuevoEstado)
	...
	// Devuelve una lista ordenada (descendente) de 4-tuplas con los datos:
	// Actividad o Salida | Proveedor | Tipo | Cantidad de visitas
	List<String[]> obtenerDatosVisitas();

	List<DTActividadTuristica> filtrarActividades(String filtro, String departamento, String categoria,

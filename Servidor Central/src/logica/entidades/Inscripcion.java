...
public class Inscripcion {
	...
	public Inscripcion(LocalDate fechaInscrpicion, int cantidadTuristas, SalidaTuristica salidaTuristica, Turista tur,
			Compra compra, String nombreActividad)
	...
	public DTInscripcion obtenerDTInscripcion() {
		return new DTInscripcion(fechaInscrpicion, cantidadTuristas, getCostoInscripcion(),
				getSalidaTuristica().obtenerDTSalidaTuristica(), getTurista().getNickname(),
				(getCompra() != null) ? getCompra().obtenerDTCompra() : null);
	}

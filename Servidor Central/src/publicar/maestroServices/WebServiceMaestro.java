...
public class WebServiceMaestro {
    ...
    @WebMethod
    public DtResultadoBusqueda buscar(String filtro, String departamentoFiltro, String categoriaFiltrada , TipoOrdenacion tipoOrdenacion){
        ...
        List<DTActividadTuristica> filtrarPorActividad = Fabrica.getInstancia().getIControladorActividadTuristica().filtrarActividades(filtro,departamentoFiltro, categoriaFiltrada, tipoOrdenacion );
        List<DTPaquete> filtrarPaquete = Fabrica.getInstancia().getIControladorPaquete().filtrarPaquetes(filtro, categoriaFiltrada, tipoOrdenacion );
